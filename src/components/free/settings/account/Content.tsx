...
import { Delete } from "components/swipe_modules/account_module/Delete";
          ...
          <div className="flex flex-col gap-[20px] w-[100%] lg:w-[450px]">
            ...
            <div>
              <div className="flex flex-col gap-[20px] pt-[20px]">
                ...
                <div
                  className="transition-transform ease-in-out duration-300 absolute top-[650px] lg:top-[700px] left-0 w-[100%]"
                  style={{
