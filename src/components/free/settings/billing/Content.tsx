        ...
        <div className="lg:w-[550px]">
          ...
          <div className="flex flex-col lg:gap-[72px] gap-[30px]">
            ...
            <div>
              ...
              <hr className="bg-[#CCD0D8] mt-[10px]" />
              <div className="py-[16px] mt-[20px] lg:px-[24px] flex flex-col gap-[16px] rounded-[4px] border-[1px] border-[#1463F3] text-[#323336] text-[16px] lg:text-[18px] font-[400] leading-[140%] lg:tracking-[0.18px] tracking-[0.16px]">
                <div className="flex items-center gap-[10px] lg:justify-start justify-center">
                  ...
                  >
                    <path
                      d="M16.0003 20.3306C15.8567 20.3306 15.7242 20.3071 15.6029 20.2601C15.4815 20.2131 15.3627 20.1315 15.2465 20.0152L11.7542 16.5229C11.6242 16.393 11.5563 16.24 11.5503 16.0639C11.5443 15.8879 11.6123 15.7263 11.7542 15.5793C11.9012 15.4323 12.0597 15.3575 12.2298 15.3549C12.3999 15.3524 12.5584 15.4246 12.7055 15.5716L15.3337 18.1998V7.33317C15.3337 7.14342 15.3973 6.98487 15.5247 6.85754C15.652 6.73018 15.8106 6.6665 16.0003 6.6665C16.1901 6.6665 16.3486 6.73018 16.476 6.85754C16.6033 6.98487 16.667 7.14342 16.667 7.33317V18.1998L19.2952 15.5716C19.4251 15.4417 19.5794 15.3737 19.758 15.3678C19.9366 15.3618 20.0995 15.4323 20.2465 15.5793C20.3884 15.7263 20.4606 15.8836 20.4632 16.0511C20.4657 16.2186 20.3935 16.3759 20.2465 16.5229L16.7542 20.0152C16.6379 20.1315 16.5191 20.2131 16.3978 20.2601C16.2764 20.3071 16.1439 20.3306 16.0003 20.3306ZM8.82083 25.3332C8.20716 25.3332 7.69477 25.1276 7.28366 24.7165C6.87255 24.3054 6.66699 23.793 6.66699 23.1793V20.6152C6.66699 20.4255 6.73067 20.2669 6.85803 20.1396C6.98536 20.0122 7.1439 19.9486 7.33366 19.9486C7.52339 19.9486 7.68194 20.0122 7.80929 20.1396C7.93665 20.2669 8.00033 20.4255 8.00033 20.6152V23.1793C8.00033 23.3844 8.08579 23.5725 8.25673 23.7434C8.42768 23.9144 8.61571 23.9998 8.82083 23.9998H23.1798C23.3849 23.9998 23.573 23.9144 23.7439 23.7434C23.9149 23.5725 24.0003 23.3844 24.0003 23.1793V20.6152C24.0003 20.4255 24.064 20.2669 24.1914 20.1396C24.3187 20.0122 24.4773 19.9486 24.667 19.9486C24.8567 19.9486 25.0153 20.0122 25.1426 20.1396C25.27 20.2669 25.3337 20.4255 25.3337 20.6152V23.1793C25.3337 23.793 25.1281 24.3054 24.717 24.7165C24.3059 25.1276 23.7935 25.3332 23.1798 25.3332H8.82083Z"
                      fill="#1D2023"
                    />
                  </svg>
                </div>
