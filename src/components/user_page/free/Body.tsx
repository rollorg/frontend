    ...
    <>
      ...
      >
        ...
        <div className="flex flex-col gap-[24px] lg:gap-[50px] xl:w-[714px pt-[30px] lg:pt-[50px]">
          ...
          <div className="flex flex-col gap-[24px] p-[16px] lg:p-[24px] rounded-[8px] border border-[#92B7F9] lg:w-[714px] mb-[20px] xl:mb-[100px] lg:h-[491px]">
            ...
            <div className="text-[#323336] lg:w-[665px] flex flex-col h-[300px] gap-[24px]">
              {/* <p>
